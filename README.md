...
装好之后不用翻文档。第一次对 AI 说「CYYD」或「这个技能包是干嘛的」，总入口会：

1. **完整介绍 9 个智能体**——每个三句话：它是谁、你给它什么、它还你什么
2. **给你三条常用路线**——没起色怎么串着用、从零起号怎么走、临时有活找谁
3. **日常帮你对号入座**——说「我想做短视频」这种模糊的话也没关系，它问一句关键问题就能把路定下来，还会提醒你去找对应智能体要带什么材料
